var examples = [
  {
    ssml:
      '<lang xml:lang="en-US" voice="F04">Have you heard the story of the Hare and the Tortoise? Well, it went something like this. The hare fell asleep during a race against the tortoise and the tortoise beat the hare in that race.</lang>' +
  ...
  },
  {
    ...
    display:
      'Look how fast I can talk now! She sells seashells by the seashore.',
  },
  {
    // 20% to %200, x-slow, slow, medium, fast, x-fast
  ...
  },
  {
    ...
    display:
      'You can use another voice in a sentence. Peanut butter and jelly sandwiches are sandwichs au beurre de cacahuète et à la confiture in French.',
  },
  {
...
export default function saySomethingInteresting() {
